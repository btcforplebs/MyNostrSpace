  ...
  useEffect(() => {
    ...
    const fetchMyBadges = async () => {
      ...
      try {
        ...
        const definitions: BadgeDefinition[] = Array.from(events)
          .map((event) => ({
          ...
          <div className="badge-modal-form">
            <label>
              ...
              <select
                ...
                onChange={(e) =>
                  setSelectedBadge(myBadges.find((b) => b.id === e.target.value) || null)
                }
              >
                {myBadges.map((badge) => (
