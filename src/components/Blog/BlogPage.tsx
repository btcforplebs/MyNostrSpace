...
import { NDKEvent, NDKKind, type NDKFilter, type NDKUserProfile } from '@nostr-dev-kit/ndk';
...
export const BlogPage: React.FC = () => {
  ...
  const [author, setAuthor] = useState<NDKUserProfile | null>(null);
      ...
      <div className="blog-container">
        <header className="blog-header">
          ...
          <div className="blog-title-box">
            <h2>
              {author?.name || author?.displayName || author?.display_name || pubkey?.slice(0, 8)}'s
              Journal
            </h2>
          </div>
        </header>
