...
export const GAMES_LIST: Game[] = [
    {
        ...
        description: 'Fly through the Bitcoin price charts! A Nostr-themed take on the classic Flappy Bird.',
        ...
        <div className="games-page-container">
            <div className="games-wrapper">
                ...
                <div className="games-content">
                    ...
                    <p style={{ marginBottom: '20px', color: '#666' }}>Play games powered by Nostr and Lightning.</p>
