...
export const MusicPage = () => {
    ...
    return (
        <div className="music-page-container">
            <div className="music-header-area">
                <Navbar />
            </div>
            ...
            <div className="music-content">
                        ...
                        {tracks.map((track, index) => (
                            ...
                            >
                                <div className="album-art-wrapper">
                                    <img
                                        src={track.albumArtUrl || '/placeholder-art.png'}
                                        alt={`${track.title} Album Art`}
                                        className="album-art"
                                        onError={(e) => {
                                            (e.target as HTMLImageElement).src = 'https://via.placeholder.com/150?text=No+Art';
                                        }}
                                    />
                                </div>
                ...
                {!loading && tracks.length === 0 && (
                    <div style={{ padding: '20px', textAlign: 'center' }}>No tracks found right now. Check back later!</div>
                )}
            </div>
        </div >
    );
