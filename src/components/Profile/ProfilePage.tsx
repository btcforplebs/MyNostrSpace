...
const ProfilePage = () => {
    ...
    const displayName = profile?.displayName || profile?.name || (hexPubkey ? `${hexPubkey.slice(0, 8)}...` : 'User');
            ...
            <div className="profile-body">
                    ...
                    <div className="profile-pic-box">
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                            {profile?.image ? (
                                ...
                                <div className="profile-pic" style={{ background: '#eee', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>?</div>
                            )}
                            ...
                            <div className="mood-box" style={{ fontSize: '8pt' }}>
                                View My: <a href="#" onClick={(e) => { e.preventDefault(); alert("Coming soon!"); }}>Pics</a> | <a href="#" onClick={(e) => { e.preventDefault(); alert("Coming soon!"); }}>Videos</a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="right-column">
                    <div className="extended-network" style={{ border: '1px solid black', padding: '10px', marginBottom: '15px', background: '#f5f5f5' }}>
                        <h2 style={{ fontSize: '14pt', margin: 0 }}>{displayName} is in your extended network</h2>
                    </div>
                    ...
                    <div className="top-8-section">
                        ...
                        <div className="top-8-grid">
                            {top8Loading ? (
                                ...
                                top8.map((friend) => (
                                    ...
                                    >
                                        <a href={`/p/${friend.profile?.nip05 || friend.profile?.name || friend.pubkey}`}>
                        ...
                        <div style={{ textAlign: 'right', marginTop: '10px', fontSize: '10pt', fontWeight: 'bold' }}>
                            View {displayName}'s Friends: <a href={`/p/${hexPubkey}/friends`}>All</a> | <a href="#" onClick={(e) => { e.preventDefault(); alert("Coming soon!"); }}>Online</a> | <a href="#" onClick={(e) => { e.preventDefault(); alert("Coming soon!"); }}>New</a>
                        </div>
                    </div>
