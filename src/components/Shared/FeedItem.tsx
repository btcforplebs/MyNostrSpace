  ...
  return (
    <div className="feed-item">
      <div
        onClick={(e) => {
          e.preventDefault();
          if (event.author.profile?.picture) openLightbox(event.author.profile.picture);
        }}
        style={{ cursor: 'pointer' }}
      >
        <img
          src={event.author.profile?.picture || 'https://via.placeholder.com/50'}
          alt=""
          className="feed-user-pic"
        />
      </div>
