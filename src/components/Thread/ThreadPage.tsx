    ...
    useEffect(() => {
        ...
        const fetchThread = async () => {
            ...
            try {
                ...
                const sortedReplies = Array.from(replyEvents).sort((a, b) => (a.created_at || 0) - (b.created_at || 0));
        ...
        <div className="thread-page-container">
            ...
            <div className="thread-content">
                <div style={{ marginBottom: '10px' }}>
                    <Link to="/" style={{ color: '#003399', fontSize: '9pt', fontWeight: 'bold' }}>&laquo; Back to Home</Link>
                </div>

                <div style={{ backgroundColor: '#ff9933', color: 'black', padding: '3px 5px', fontSize: '10pt', fontWeight: 'bold', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                {!loading && rootEvent && (
                    <div className="thread-root">
                        ...
                        <div className="thread-replies" style={{ marginLeft: '20px', marginTop: '20px', borderLeft: '1px solid #ddd', paddingLeft: '10px' }}>
                            <h4 style={{ margin: '0 0 10px 0', fontSize: '10pt', color: '#666' }}>Replies</h4>
                            {replies.length === 0 && <div style={{ color: '#888', fontStyle: 'italic', fontSize: '9pt' }}>No replies yet.</div>}
                            {replies.map(reply => (
