...
export const VideoRoomPage = () => {
    ...
    const [hostProfile, setHostProfile] = useState<import('@nostr-dev-kit/ndk').NDKUserProfile | null>(null);
    ...
    const handleKillRoom = async () => {
        ...
        if (!window.confirm('Are you sure you want to KILL this room? This will delete the room event for everyone.')) {
            return;
        }
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    {isHost && (
                                        <button
                                            ...
                                            style={{ background: 'red', color: 'white', border: '1px solid darkred', padding: '2px 8px', borderRadius: '4px', cursor: 'pointer', fontSize: '0.8em', fontWeight: 'bold' }}
                                        >
                                        ...
                                        {streamUrl.includes('vdo.ninja') ? (
                                            <div style={{ width: '100%', height: '600px' }}>
                                                ...
                                                <a
                                                    ...
                                                    style={{ display: 'block', marginTop: '10px', textAlign: 'center', color: 'var(--myspace-link, #003399)', fontSize: '0.9em' }}
                                                >
                                                    Open in new tab ↗
                                                </a>
                                            </div>
                        ...
                        <div className="content-box chat-box">
                            ...
                            <div className="chat-input-area">
                                {user ? (
                                    ...
                                    <button className="post-button" onClick={() => login()}>Login to Chat</button>
                                )}
                            </div>
                        </div>
                    </div>
