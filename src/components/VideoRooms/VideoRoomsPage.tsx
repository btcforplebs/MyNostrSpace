...
export const VideoRoomsPage = () => {
  ...
  useEffect(() => {
    ...
    (window as Window & { emergencyKill?: () => Promise<void> }).emergencyKill = async () => {
  ...
  }, [ndk, processBuffer, handleRoomEvent]);
  ...
  const handleKillRoom = async (room: VideoRoom) => {
    ...
    try {
      ...
      endEvent.tags = [...actualEvent.tags.filter((t) => t[0] !== 'status'), ['status', 'ended']];
  ...
  const myLiveRooms = rooms.filter(
    (r) => loggedInUser && r.pubkey.toLowerCase() === loggedInUser.pubkey.toLowerCase()
  );
  ...
  return (
    <div className="home-page-container video-rooms-container">
      ...
      <SEO
        title="Video Rooms"
        description="Join peer-to-peer video rooms on MyNostrSpace - powered by VDO.ninja with zero server bandwidth."
      />
      ...
      <div className="home-wrapper video-rooms-wrapper">
        ...
        <div className="home-content video-rooms-content">
          ...
          {loggedInUser && myLiveRooms.length > 0 && (
            ...
            >
              <h3 style={{ color: '#cc0000', margin: '0 0 10px 0', fontSize: '1.2em' }}>
                ⚠️ My Active Rooms (Emergency Stop)
              </h3>
          ...
          <div className="create-room-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="create-room-modal-content">
              <div style={{ marginBottom: '10px' }}>
                <label style={{ display: 'block', fontSize: '0.9em', fontWeight: 'bold' }}>
                  Room Title *
                </label>
                <input
                  type="text"
